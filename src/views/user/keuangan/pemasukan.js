  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const pemasukan = await axios.get('https://smrapi.my.id/pemasukan/'+response.data.kegiatan_id, {
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
 ...
 useEffect(() => {
  ...
  const handleAddPemasukan = async (tanggal, deskripsi, sumberdana, jumlah) => {
    ...
    try {
      ...
      const response = await axios.post('https://smrapi.my.id/pemasukan', newEntry, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleUpdatePemasukan = async (no, tanggal, deskripsi, sumberdana, jumlah, id_kegiatan) => {
    try {
      ...
      const response = await axios.put(`https://smrapi.my.id/pemasukan/${selectedData.no}`, updatedEntry, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://smrapi.my.id/pemasukan/${id}`, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
