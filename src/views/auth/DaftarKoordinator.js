...
const DaftarKoordinator = () => {
  ...
  const handleSelectChange = (selectedOption) => {
    ...
    setFormData({
      ...formData,
      kecakapan: selectedOption ? selectedOption.value : ''
    });
  };
                        ...
                        <CCol md={6}>
                          ...
                          <CInputGroup className="mb-3">
                            ...
                            <Select
                              ...
                              className="basic-single-select form-control"
                              classNamePrefix="select"
                              placeholder="Pilih Kecakapan"
                              onChange={handleSelectChange}
                              value={kecakapanOptions.find(option => option.value === formData.kecakapan)}
                            />
                          </CInputGroup>
